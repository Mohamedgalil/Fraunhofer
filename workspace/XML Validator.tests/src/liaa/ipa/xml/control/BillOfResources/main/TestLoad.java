	...
	public static void main(String[] args) {
		...
		if (create) {
			...
			try {
				...
				liaa.ipa.xml.control.BillOfResources.Resource r1 = borFactory.eINSTANCE.createResource();
				r1.setId("resourceID");
				r1.setLabel("ResourceLabel");
				r1.setDescription(borFactory.eINSTANCE.createResourceDescriptor());
				root.setResources(r1);
